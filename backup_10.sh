...
echo "Backup iniciado em $(date +%d"/"%b"/"%Y" as "%T)" >> /media/arquivos/logs/BACKUP_Servidor10.txt
#####
cp -f -R -v /scripts /media/backup1/system
cp -f -R -v /etc/crontab /media/backup1/system
cp -v -R -f /media/arquivos/system /media/backup1/system4
...
clear
sleep 2
echo "Agora vamos fazer uma limpeza..."
#########################################################
